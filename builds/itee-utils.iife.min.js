...
/**
	 ...
	 */
const i=Math.PI,a=Math.PI/2,l=Math.PI/4,u=i/180,c=180/i;function f(e){return e*c}function b(e,r){if(t.isNotArray(e))return!1;if(t.isNotArray(r))return!1;let n=r[0],s=r[1],o=-1;for(let t=0,i=e.length,a=i-1;t<i;a=t++){const i=e[t],l=i[0],u=i[1],c=e[a],f=c[0],b=c[1];d(i,c,r)?o=0:u>s!=b>s&&n<(f-l)*(s-u)/(b-u)+l&&(o=-o)}return o}function d(e,r,n){if(t.isNotArray(e))return!1;if(t.isNotArray(r))return!1;if(t.isNotArray(n))return!1;const s=n[0]-e[0],o=n[1]-e[1];if(0===s&&0===o)return!0;const i=r[0]-e[0],a=r[1]-e[1];if(0===i&&0===a)return!1;const l=(s*i+o*a)/(i*i+a*a);return!(l<0||l>1)&&(0===l||1===l||l*i===s&&l*a===o)}
/**
	 * @author [Tristan Valcke]{@link https://github.com/Itee}
	 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
	 *
...
/**
	 ...
	 *
	 */
function(e){if(!t.isNotString(e)&&!t.isEmptyString(e))return e.charAt(0).toUpperCase()+e.slice(1)},e.convertWebGLRotationToTopogicalYawPitch=function(e){if(t.isNotDefined(e))return;if(t.isNotObject(e))return;const r=e;return{yaw:-(f((n=r,Math.atan2(n.y,n.x)))-90),pitch:f(function(e){return Math.asin(e.z)}(r))};var n}
/**
	 * @author [Tristan Valcke]{@link https://github.com/Itee}
	 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
	 *
...
/**
	 ...
	 */,e.numbers=m,e.objects=I,e.radiansFromDegrees=function(e){return e*u},e.radiansToDegrees=f,e.removeDiacritics=function(e){return t.isNotString(e)?null:e.replace(/[^\u0000-\u007E]/g,e=>o[e]||e)},e.ringClockwise=function(e){if(t.isNotArray(e))return!1;let r=e.length;if(r<4)return!1;let n=0,s=e[r-1][1]*e[0][0]-e[r-1][0]*e[0][1];for(;++n<r;)s+=e[n-1][1]*e[n][0]-e[n-1][0]*e[n][1];return s>=0},e.ringContains=b,e.ringContainsSome=function(e,r){if(t.isNotArray(e))return!1;if(t.isNotArray(r))return!1;let n=0,s=r.length;do{if(b(e,r[n])>0)return!0}while(++n<s);return!1},e.segmentContains=d,e.serializeObject=function(){},e.sortBy=function(e,t="asc"){const r=e;let n;if("asc"===t)n=(e,t)=>e[r]<t[r]?-1:e[r]>t[r]?1:0;else{if("desc"!==t)throw RangeError(`Got invalid ascending [${t}], but expect one of ['asc','desc']!`);n=(e,t)=>e[r]>t[r]?-1:e[r]<t[r]?1:0}return n},e.strings=N,e.toArray=function(e,r={keepArray:!1,keepNull:!1}){let n;return n=t.isArray(e)?r.keepArray?[e]:e:r.keepNull||"object"==typeof e||t.isObject(e)?[e]:[],n},e.toEnum=function(e){if(!t.isNotObject(e)){if(t.isDefined(e.toString)){const r=Object.getOwnPropertyDescriptor(e,"toString");if(t.isDefined(r)&&!1===r.configurable)return}return Object.freeze(Object.defineProperties(e,{toString:{configurable:!1,enumerable:!1,writable:!1,value(){const e=Object.keys(this);let t="";for(let r=0,n=e.length;r<n;r++)t+=`${e[r]}, `;return t=t.slice(0,-2),t}},includes:{configurable:!1,enumerable:!1,writable:!1,value(e){return Object.values(this).includes(e)}},keys:{configurable:!1,enumerable:!1,writable:!1,value(){return Object.keys(this)}},values:{configurable:!1,enumerable:!1,writable:!1,value(){return Object.values(this)}},entries:{configurable:!1,enumerable:!1,writable:!1,value(){return Object.entries(this)}}}))}},e.typedArrays=O,e.uniq=function(e){if(t.isNotArray(e))return;const r={};return e.filter(e=>!Object.prototype.hasOwnProperty.call(r,e)&&(r[e]=!0))},e.voids=p,e}({},Itee.Validators);
