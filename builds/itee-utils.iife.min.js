...
/**
	 ...
	 *
	 */
const h={null:null,undefined:void 0,void:void 0},g={true:!0,false:!1},m={negativeInfinity:Number.NEGATIVE_INFINITY,negativeMaxValue:-Number.MAX_VALUE,negativeMinSafeInteger:Number.MIN_SAFE_INTEGER,negativeMinValue:-Number.MIN_VALUE,negativeHexa:-1193046,negativePow:-200,negativePowWithDecimals:-123.45,negativeFloat:-1.01,negativeInt:-1,negativeZero:-0,nan:Number.NaN,positiveZero:0,positiveInt:1,positiveFloat:1.01,positivePowWithDecimals:123.45,positivePow:200,positiveHexa:1193046,positiveMinValue:Number.MIN_VALUE,positiveMaxSafeInteger:Number.MAX_SAFE_INTEGER,positiveMaxValue:Number.MAX_VALUE,positiveInfinity:Number.POSITIVE_INFINITY,e:Math.E,ln10:Math.LN10,ln2:Math.LN2,log10e:Math.LOG10E,log2e:Math.LOG2E,pi:Math.PI,sqrt1_2:Math.SQRT1_2,sqrt2:Math.SQRT2},y=(()=>{const e={empty:"",blank:"      ",stringNull:String(),stringEmpty:String(""),stringBlank:String("    "),foobar:"foobar"},t=h;for(let r=0,n=t.length;r<n;r++)e[t[r]]=`${t[r]}`;const r=g;for(let t=0,n=r.length;t<n;t++)e[r[t]]=`${r[t]}`;const n=m;for(let t=0,r=n.length;t<r;t++)e[n[t]]=`${n[t]}`;return e})(),v={anonymousFunction:function(){},namedFunction:function(){},arrowFunction:()=>{}},I={emptyArray:[],emptyArrayObject:new Array,singleValued:[0],multiValued:[0,1,2],null:(()=>{const e=[];for(let t=0;t<3;t++)e.push(null);return e})(),undefined:(()=>{const e=[];for(let t=0;t<3;t++)e.push(void 0);return e})(),void:(()=>{const e=[];for(let t=0;t<3;t++)e.push(void 0);return e})(),voids:(()=>{const e=[],t=h;for(let r in t)e.push(t[r]);return e})(),booleans:(()=>{const e=[],t=g;for(let r in t)e.push(t[r]);return e})(),numbers:(()=>{const e=[],t=m;for(let r in t)e.push(t[r]);return e})(),strings:(()=>{const e=[],t=y;for(let r in t)e.push(t[r]);return e})(),functions:(()=>{const e=[],t=v;for(let r in t)e.push(t[r]);return e})(),objects:[{foo:"bar"},{baz:"qux"}],arrays:[[1,2,3],[4,5,6],[7,8,9]]},A={int8Array:new Int8Array([1,2,3]),uInt8Array:new Uint8Array([1,2,3]),int16Array:new Int16Array([1,2,3]),uInt16Array:new Uint16Array([1,2,3]),int32Array:new Int32Array([1,2,3]),uInt32Array:new Uint32Array([1,2,3]),float32Array:new Float32Array([1,2,3]),float64Array:new Float64Array([1,2,3])},O={empty:{},instance:new Object,null:{null:null},undefined:{undefined:void 0},foo:{foo:"bar"}},N={voids:h,booleans:g,numbers:m,strings:y,functions:v,arrays:I,typedArrays:A,objects:O},w={DataMap:void 0,createDataMap:function(e){void 0===e&&(e={voids:[],booleans:[],numbers:[],strings:[],functions:[],arrays:[],typedArrays:[],objects:[]});let t={};for(let r in e){const n=N[r];if(void 0===n)throw ReferenceError(`The global data map does not contain element for key: ${r}`);const s=e[r];if(t[r]={},0===s.length)for(let e in n)t[r][e]=n[e];else for(let e=0,a=s.length;e<a;e++)t[r][s[e]]=n[s[e]]}return t},createDataMapBenchmarkOptions:function(e){return Itee.Testing.DataMap=Itee.Testing.createDataMap(e),{setup:function(){this.datamap=Itee.Testing.DataMap},teardown:function(){delete this.datamap}}},iterateOverDataMap:function(e){return function(){const t=this.datamap;for(let r in t){const n=t[r];if(Array.isArray(n))for(let t=0,r=n.length;t<r;t++){const r=n[t];e(r)}else for(let t in n){const r=n[t];e(r)}}}},createDataSet:function(e){void 0===e&&(e={voids:[],booleans:[],numbers:[],strings:[],functions:[],arrays:[],typedArrays:[],objects:[]});let t=[];for(let r in e){const n=N[r],s=e[r];if(0===s.length)for(let e in n)t.push(n[e]);else for(let e=0,r=s.length;e<r;e++)t.push(n[s[e]])}return t},createDataSetBenchmarkOptions:function(e){return{setup:function(){this.dataset=Itee.Testing.createDataSet()[e]},teardown:function(){delete this.dataset}}},iterateOverDataSet:function(e){return function(){const t=this.dataset;for(let r=0,n=t.length;r<n;r++)e(t[r])}}};return e.DEG_TO_RAD=l,e.FAHRENHEIT_CELSIUS_COEFFICIENT=p,e.FAHRENHEIT_CELSIUS_CONSTANTE=32,e.KELVIN_CELSIUS_CONSTANTE=d,e.PI=a,e.PI_2=i,e.PI_4=o,e.RAD_TO_DEG=u,e.Testing=w,e.bitsToByte=n,e.byteToBits=r,e.celsiusToFahrenheit=function(e,r){if(t.isNotTemperature(e))throw new Error("Require first operand as an temperature in celsius !");const n=t.isNotEmpty(r)&&t.isNumber(r)?r:2;return(e*p+32).toFixed(n)},e.celsiusToKelvin=function(e,r){if(t.isNotTemperature(e))throw new Error("Require first operand as an temperature in celsius !");const n=t.isNotEmpty(r)&&t.isNumber(r)?r:2;return(e+d).toFixed(n)},e.classNameify=
/**
	 * @author [Tristan Valcke]{@link https://github.com/Itee}
	 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
	 *
