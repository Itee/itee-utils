 ...
 * }
 *
 */function w(e){return!function(e){return t.existsSync(e)}(e)}
/**
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 *
 ...
 * }
 *
 */function F(e){if(M(e)&&!(e instanceof Buffer)&&!(e instanceof URL))throw new TypeError("Invalid path type! Expect string, buffer or url.");const r=t.statSync(e,{throwIfNoEntry:!1});return S(r)&&r.isDirectory()}
/**
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 *
 ...
 * }
 *
 */function T(e){if(M(e)&&!(e instanceof Buffer)&&!(e instanceof URL))throw new TypeError("Invalid path type! Expect string, buffer or url.");const r=t.statSync(e,{throwIfNoEntry:!1});return S(r)&&r.isFile()}
/**
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 *
 ...
 *
 */function D(e){return s.default.readdirSync(e)}function $(e){return s.default.existsSync(e)}function P(e){if(!$(e))throw new Error(`Invalid file path "${e}" file does not exist !`);return s.default.readFileSync(e,"utf8")}exports.DEG_TO_RAD=b,exports.FAHRENHEIT_CELSIUS_COEFFICIENT=1.8,exports.FAHRENHEIT_CELSIUS_CONSTANTE=32,exports.KELVIN_CELSIUS_CONSTANTE=273.14999999955,exports.PI=u,exports.PI_2=c,exports.PI_4=f,exports.RAD_TO_DEG=p,exports.Testing=I,exports.arrays=A,exports.bitsToByte=a,exports.booleans=m,exports.byteToBits=i,exports.celsiusToFahrenheit=function(t,r){if(e.isNotTemperature(t))return;const n=e.isNotEmpty(r)&&e.isNumber(r)?r:2;return(1.8*t+32).toFixed(n)},exports.celsiusToKelvin=function(t,r){if(e.isNotTemperature(t))return;const n=e.isNotEmpty(r)&&e.isNumber(r)?r:2;return(t+273.14999999955).toFixed(n)},exports.classNameify=
/**
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 *
