 ...
 * }
 *
 */function j(e){return!function(e){return s.default.existsSync(e)}(e)}
/**
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 *
 ...
 * }
 *
 */function F(e){if(M(e)&&!(e instanceof Buffer)&&!(e instanceof URL))throw new TypeError("Invalid path type! Expect string, buffer or url.");const t=s.default.statSync(e,{throwIfNoEntry:!1});return S(t)&&t.isDirectory()}
/**
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 *
 ...
 * }
 *
 */function T(e){if(M(e)&&!(e instanceof Buffer)&&!(e instanceof URL))throw new TypeError("Invalid path type! Expect string, buffer or url.");const t=s.default.statSync(e,{throwIfNoEntry:!1});return S(t)&&t.isFile()}
/**
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 *
 ...
 *
 */function D(e){return s.default.readdirSync(e)}function $(e){return s.default.existsSync(e)}function P(e){if(!$(e))throw new Error(`Invalid file path "${e}" file does not exist !`);return s.default.readFileSync(e,"utf8")}exports.DEG_TO_RAD=p,exports.FAHRENHEIT_CELSIUS_COEFFICIENT=1.8,exports.FAHRENHEIT_CELSIUS_CONSTANTE=32,exports.KELVIN_CELSIUS_CONSTANTE=273.14999999955,exports.PI=u,exports.PI_2=c,exports.PI_4=f,exports.RAD_TO_DEG=b,exports.Testing=w,exports.arrays=A,exports.bitsToByte=a,exports.booleans=m,exports.byteToBits=i,exports.celsiusToFahrenheit=function(t,r){if(e.isNotTemperature(t))return;const n=e.isNotEmpty(r)&&e.isNumber(r)?r:2;return(1.8*t+32).toFixed(n)},exports.celsiusToKelvin=function(t,r){if(e.isNotTemperature(t))return;const n=e.isNotEmpty(r)&&e.isNumber(r)?r:2;return(t+273.14999999955).toFixed(n)},exports.classNameify=
/**
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 *
 ...
 *
 */
function(t){if(!e.isNotString(t)&&!e.isEmptyString(t))return t.charAt(0).toUpperCase()+t.slice(1)},exports.convertWebGLRotationToTopogicalYawPitch=function(t){if(e.isNotDefined(t))return;if(e.isNotObject(t))return;const r=t;return{yaw:-(h((n=r,Math.atan2(n.y,n.x)))-90),pitch:h(function(e){return Math.asin(e.z)}(r))};var n}
/**
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 *
 ...
 *
 */,exports.createInterval=function(e,t,r){if(!e)return;if(!t)return;if(!r)return;let n=0;setInterval((function(){n>=1?n=0:n+.1>1?n=1:n+=.1;const r=t.getLength();let s,o,i,a=n;for(let n=0,l=e.children.length;n<l;n++)o=e.children[n],s=a/r,s>1&&(s=0),i=t.getPointAt(s),i.y+=.1,o.position.copy(i),a+=1}),r)},exports.degreesFromRadians=function(e){return e*b},exports.degreesToRadians=function(e){return e*p},exports.excludesFilesPaths=function(e,t){let r,n=[];for(let t=0,o=e.length;t<o;t++)r=e[t],s(r)||n.push(r);return n;function s(e){let r,n=!1;for(let s=0,o=t.length;s<o;s++)if(r=t[s],r.indexOf(".")>-1){e.replace(/^.*(\\|\/|\\:)/,"")===r&&(n=!0)}else e.contains(r)&&(n=!0);return n}},exports.extend=function t(r,n){let s;if(e.isObject(r)&&e.isNotDefined(n))s=Object.assign({},r);else if(e.isNotDefined(r)&&e.isObject(n))s=Object.assign({},n);else if(e.isObject(r)&&e.isObject(n)){s=Object.assign({},r);const o=Object.keys(n);for(let i=0,a=o.length;i<a;++i){let a=o[i];e.isObject(n[a])?a in r?s[a]=t(r[a],n[a]):Object.assign(s,{[a]:n[a]}):Object.assign(s,{[a]:n[a]})}}else s=null;return s},exports.extendObject=function t(r,n){if(!e.isUndefined(r)&&!e.isUndefined(n)){if(r.constructor===Function&&n.constructor===Function)r.prototype=new n,r.prototype.parent=n.prototype,r.prototype.constructor=r;else if(r.constructor===Function&&n.constructor===Object)r.prototype=n,r.prototype.parent=n,r.prototype.constructor=r;else if(r.constructor===Object&&n.constructor===Object)for(let e in n)Object.prototype.hasOwnProperty.call(r,e)&&(n[e].constructor===Object||n[e].constructor===Array)?r[e]=t(r[e],n[e]):r[e]=n[e];else{if(r.constructor!==Array||n.constructor!==Array)throw r.constructor===Object&&n.constructor===Array||r.constructor===Array&&n.constructor===Object?new Error("Cannot perform extend of object with an array"):new Error("Cannot perform extend given parameters...");r=r.concat(n)}return r}},exports.fahrenheitToCelsius=function(t,r){if(e.isNotTemperature(t))return;const n=e.isNotEmpty(r)&&e.isNumber(r)?r:2;return((t-32)/1.8).toFixed(n)},exports.fahrenheitToKelvin=function(t,r){if(e.isNotTemperature(t))return;const n=e.isNotEmpty(r)&&e.isNumber(r)?r:2;return((t-32)/1.8+273.14999999955).toFixed(n)},exports.fileExistForPath=$,exports.filterJavascriptFiles=function(e,t){let r,n=[];for(let s=0,i=e.length;s<i;s++)if(r=e[s],!t||t(r)){{const e=o.default.extname(r);if(r.indexOf("glsl")>-1||".js"!==e)continue}n.push(r)}return n},exports.functions=v,exports.getFileForPath=P,exports.getFilesPathsUnder=function t(r){const n=e.isArray(r)?r:[r];let s=[];for(let e=0,r=n.length;e<r;e++){const r=n[e];if(j(r))throw new Error(`The path "${r}" is not valid !`);if(T(r))s.push(r);else if(F(r)){const e=D(r).map((e=>t(o.default.resolve(r,e))));e&&(s=[].concat(...e))}}return s},exports.getFilesPathsUnder_1=function(e){let t=[];if(Array.isArray(e)){let t;for(let n=0,s=e.length;n<s;n++)t=e[n],r(t)}else r(e);return t;function r(e){if(!$(e))return void console.error('ES6Converter: Invalid file path "'+e+'"');const n=s.default.statSync(e);var i;n.isFile()?t.push(e):n.isDirectory()?Array.prototype.push.apply(t,(i=e,void s.default.readdirSync(i).forEach((e=>{r(o.default.resolve(i,e))})))):console.error("Invalid stat object !")}},exports.getPathsUnder=D,exports.getPitch=function(t){if(!e.isNotDefined(t)&&!e.isNotObject(t))return Math.asin(t.y)},exports.getRandom=
/**
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 *
 ...
 */,exports.numbers=x,exports.objects=E,exports.radiansFromDegrees=function(e){return e*p},exports.radiansToDegrees=h,exports.removeDiacritics=function(t){return e.isNotString(t)?null:t.replace(/[^\u0000-\u007E]/g,(e=>l[e]||e))},exports.ringClockwise=function(t){if(e.isNotArray(t))return!1;let r=t.length;if(r<4)return!1;let n=0,s=t[r-1][1]*t[0][0]-t[r-1][0]*t[0][1];for(;++n<r;)s+=t[n-1][1]*t[n][0]-t[n-1][0]*t[n][1];return s>=0},exports.ringContains=d,exports.ringContainsSome=function(t,r){if(e.isNotArray(t))return!1;if(e.isNotArray(r))return!1;let n=0,s=r.length;do{if(d(t,r[n])>0)return!0}while(++n<s);return!1},exports.segmentContains=g,exports.serializeObject=function(){},exports.sortBy=
/**
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 *
