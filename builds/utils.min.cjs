 ...
 */const g=1.8,y=273.14999999955;
/**
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */
const m={null:null,undefined:void 0,void:void 0},x={true:!0,false:!1},v={negativeInfinity:Number.NEGATIVE_INFINITY,negativeMaxValue:-Number.MAX_VALUE,negativeMinSafeInteger:Number.MIN_SAFE_INTEGER,negativeMinValue:-Number.MIN_VALUE,negativeHexa:-1193046,negativePow:-200,negativePowWithDecimals:-123.45,negativeFloat:-1.01,negativeInt:-1,negativeZero:-0,negativeNan:-Number.NaN,positiveNan:Number.NaN,positiveZero:0,positiveInt:1,positiveFloat:1.01,positivePowWithDecimals:123.45,positivePow:200,positiveHexa:1193046,epsilon:Number.EPSILON,positiveMinValue:Number.MIN_VALUE,positiveMaxSafeInteger:Number.MAX_SAFE_INTEGER,positiveMaxValue:Number.MAX_VALUE,positiveInfinity:Number.POSITIVE_INFINITY,e:Math.E,ln10:Math.LN10,ln2:Math.LN2,log10e:Math.LOG10E,log2e:Math.LOG2E,pi:Math.PI,sqrt1_2:Math.SQRT1_2,sqrt2:Math.SQRT2},N=(()=>{const e={empty:"",blank:"      ",stringNull:String(),stringEmpty:String(""),stringBlank:String("    "),foobar:"foobar",stringHexa:"#123456",stringOcta:"00101010"},t=m;for(let r=0,n=t.length;r<n;r++)e[t[r]]=`${t[r]}`;const r=x;for(let t=0,n=r.length;t<n;t++)e[r[t]]=`${r[t]}`;const n=v;for(let t=0,r=n.length;t<r;t++)e[n[t]]=`${n[t]}`;return e})(),A={anonymousFunction:function(){},namedFunction:function(){},arrowFunction:()=>{}},O={emptyArray:[],emptyArrayObject:new Array,singleValued:[0],multiValued:[0,1,2],null:[null,null,null],undefined:[void 0,void 0,void 0],void:[void 0,void 0,void 0],voids:Object.values(m),booleans:Object.values(x),numbers:Object.values(v),strings:Object.values(N),functions:Object.values(A),objects:[{foo:"bar"},{baz:"qux"}],arrays:[[1,2,3],[4,5,6],[7,8,9]]},E={int8Array:new Int8Array([1,2,3]),uInt8Array:new Uint8Array([1,2,3]),int16Array:new Int16Array([1,2,3]),uInt16Array:new Uint16Array([1,2,3]),int32Array:new Int32Array([1,2,3]),uInt32Array:new Uint32Array([1,2,3]),float32Array:new Float32Array([1,2,3]),float64Array:new Float64Array([1,2,3])},j={empty:{},instance:new Object,null:{null:null},undefined:{undefined:void 0},foo:{foo:"bar"}};var I=Object.freeze({__proto__:null,arrays:O,booleans:x,functions:A,numbers:v,objects:j,strings:N,typedArrays:E,voids:m});
/**
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */const w={DataMap:void 0,createDataMap:function(e){void 0===e&&(e={voids:[],booleans:[],numbers:[],strings:[],functions:[],arrays:[],typedArrays:[],objects:[]});let t={};for(let r in e){const n=I[r];if(void 0===n)throw ReferenceError(`The global data map does not contain element for key: ${r}`);const s=e[r];if(t[r]={},0===s.length)for(let e in n)t[r][e]=n[e];else for(let e=0,o=s.length;e<o;e++)t[r][s[e]]=n[s[e]]}return t},createBenchmarkOptions:function(e){return w.DataMap=w.createDataMap(e),{onStart:function(){this.benchDataMap=w.DataMap},onCycle:function(){},onAbort:function(){console.log(`${this.constructor.name} [${this.name}] onAbort`)},onError:function(e){console.log(`${this.constructor.name} [${this.name}] onError`),console.error(e.message)},onReset:function(){console.log(`${this.constructor.name} [${this.name}] onReset`)},onComplete:function(){delete this.benchDataMap},setup:function(){},teardown:function(){}}},createSuiteOptions:function(){let e;return e={onStart:function(){console.log(`Running ${this.constructor.name}: ${this.name}`),this.results=[]},onCycle:function(e){console.log(`Running Bench: ${e.target.name}`),this.results.push(e.target)},onAbort:function(){},onError:function(){},onReset:function(){},onComplete:function(){this.results.sort((e,t)=>e.hz<t.hz?1:e.hz>t.hz?-1:0);for(let e=0,t=this.results.length;e<t;e++)console.log(`${e}: ${String(this.results[e])}`);const e=this.results[0],t=this.results[this.results.length-1],r=(e.hz-t.hz)/t.hz*100;console.log(`\n${e.name} is ${Math.round(r)}% fastest than ${t.name}`),delete this.results}},e},iterateOverDataMap:function(e){return function(){if(void 0===e)throw new ReferenceError("the method param is null or undefined!");const t=this.benchDataMap;for(let r in t){const n=t[r];if(Array.isArray(n))for(let t of n)try{e(t)}catch(r){const n=null===t?"null":void 0===t?"undefined":t.toString();console.error(`method [${e.name} fail with [${n}] => ${r.message}`)}else for(let t in n){const r=n[t];try{e(r)}catch(t){const n=null===r?"null":void 0===r?"undefined":r.toString();console.error(`method [${e.name} fail with [${n}] => ${t.message}`)}}}}},createDataSet:function(e){void 0===e&&(e={voids:[],booleans:[],numbers:[],strings:[],functions:[],arrays:[],typedArrays:[],objects:[]});let t=[];for(let r in e){const n=I[r],s=e[r];if(0===s.length)for(let e in n)t.push(n[e]);else for(let e=0,r=s.length;e<r;e++)t.push(n[s[e]])}return t},createDataSetBenchmarkOptions:function(e){return{setup:function(){this.dataset=w.createDataSet()[e]},teardown:function(){delete this.dataset}}},iterateOverDataSet:function(e){return function(){const t=this.dataset;for(let r=0,n=t.length;r<n;r++)e(t[r])}}};
/**
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 *
 ...
 * }
 *
 */function D(e){return!function(e){return t.existsSync(e)}(e)}
/**
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 *
 ...
 *
 */function $(e){return t.readdirSync(e)}function _(e){return t.existsSync(e)}function P(e){if(!_(e))throw new Error(`Invalid file path "${e}" file does not exist !`);return t.readFileSync(e,"utf8")}exports.DEG_TO_RAD=f,exports.FAHRENHEIT_CELSIUS_COEFFICIENT=g,exports.FAHRENHEIT_CELSIUS_CONSTANTE=32,exports.KELVIN_CELSIUS_CONSTANTE=y,exports.PI=l,exports.PI_2=u,exports.PI_4=c,exports.RAD_TO_DEG=b,exports.Testing=w,exports.arrays=O,exports.bitsToByte=o,exports.booleans=x,exports.byteToBits=s,exports.celsiusToFahrenheit=function(t,r){if(e.isNotTemperature(t))return;const n=e.isNotEmpty(r)&&e.isNumber(r)?r:2;return(t*g+32).toFixed(n)},exports.celsiusToKelvin=function(t,r){if(e.isNotTemperature(t))return;const n=e.isNotEmpty(r)&&e.isNumber(r)?r:2;return(t+y).toFixed(n)},exports.classNameify=
/**
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 *
 ...
 *
 */
function(t){if(!e.isNotString(t)&&!e.isEmptyString(t))return t.charAt(0).toUpperCase()+t.slice(1)},exports.convertWebGLRotationToTopogicalYawPitch=function(t){if(e.isNotDefined(t))return;if(e.isNotObject(t))return;const r=t;return{yaw:-(p((n=r,Math.atan2(n.y,n.x)))-90),pitch:p(function(e){return Math.asin(e.z)}(r))};var n}
/**
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 *
 ...
 */,exports.numbers=v,exports.objects=j,exports.radiansFromDegrees=function(e){return e*f},exports.radiansToDegrees=p,exports.removeDiacritics=function(t){return e.isNotString(t)?null:t.replace(/[^\u0000-\u007E]/g,e=>a[e]||e)},exports.ringClockwise=function(t){if(e.isNotArray(t))return!1;let r=t.length;if(r<4)return!1;let n=0,s=t[r-1][1]*t[0][0]-t[r-1][0]*t[0][1];for(;++n<r;)s+=t[n-1][1]*t[n][0]-t[n-1][0]*t[n][1];return s>=0},exports.ringContains=h,exports.ringContainsSome=function(t,r){if(e.isNotArray(t))return!1;if(e.isNotArray(r))return!1;let n=0,s=r.length;do{if(h(t,r[n])>0)return!0}while(++n<s);return!1},exports.segmentContains=d,exports.serializeObject=function(){},exports.sortBy=function(e,t="asc"){const r=e;let n;if("asc"===t)n=(e,t)=>e[r]<t[r]?-1:e[r]>t[r]?1:0;else{if("desc"!==t)throw RangeError(`Got invalid ascending [${t}], but expect one of ['asc','desc']!`);n=(e,t)=>e[r]>t[r]?-1:e[r]<t[r]?1:0}return n},exports.strings=N,exports.toArray=function(t,r={keepArray:!1,keepNull:!1}){let n;return n=e.isArray(t)?r.keepArray?[t]:t:r.keepNull||"object"==typeof t||e.isObject(t)?[t]:[],n},exports.toEnum=function(t){if(!e.isNotObject(t)){if(e.isDefined(t.toString)){const r=Object.getOwnPropertyDescriptor(t,"toString");if(e.isDefined(r)&&!1===r.configurable)return}return Object.freeze(Object.defineProperties(t,{toString:{configurable:!1,enumerable:!1,writable:!1,value(){const e=Object.keys(this);let t="";for(let r=0,n=e.length;r<n;r++)t+=`${e[r]}, `;return t=t.slice(0,-2),t}},includes:{configurable:!1,enumerable:!1,writable:!1,value(e){return Object.values(this).includes(e)}},keys:{configurable:!1,enumerable:!1,writable:!1,value(){return Object.keys(this)}},values:{configurable:!1,enumerable:!1,writable:!1,value(){return Object.values(this)}},entries:{configurable:!1,enumerable:!1,writable:!1,value(){return Object.entries(this)}}}))}},exports.typedArrays=E,exports.uniq=function(t){if(e.isNotArray(t))return;const r={};return t.filter(e=>!Object.prototype.hasOwnProperty.call(r,e)&&(r[e]=!0))},exports.voids=m;
